...
applyTo:
  ...
  - "src/player/frame_update.py"
  - "src/player/update_dialog.py"
  - "src/player/update_service.py"
---
...
- Preserve the release asset contract expected by `src/player/update_service.py`: `MediaPlayer-windows.zip`, `MediaPlayer-windows.zip.sha256`, and `MediaPlayerUpdater.exe` for packaged Windows installs.
